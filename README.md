...
<div itemscope itemtype="http://schema.org/Dataset">
  <table>
    ...
    <tr>
      <td>name</td>
      <td><code itemprop="name">Open source aligned text corpus English, German, French, Italian, Japanese, Portuguese, Spanish, Occitan, Galician, Basque, etc to/from Catalan.</code></td>
    </tr>
    <tr>
      <td>description</td>
